...
public class ProductService {
    ...
    public ProductService() {
        ...
        products.put(13L, Product.builder().id(13L).type(ProductType.DRINGS).name("Coca-Cola").description("0,5л").cost(50).img("https://www.officemag.ru/goods/620870/49061b8b93af1bc7a9ff07b2892d49c1_xl.jpg").build());
        products.put(14L, Product.builder().id(14L).type(ProductType.DRINGS).name("Fuzetea").description("1л").cost(70).img("https://mineralka.store/wa-data/public/shop/products/86/90/9086/images/6477/6477.970.jpg").build());
        products.put(15L, Product.builder().id(15L).type(ProductType.DRINGS).name("Sprite").description("1л").cost(60).img("https://avatanplus.com/files/resources/original/579769db455d615627758094.png").build());
        products.put(16L, Product.builder().id(16L).type(ProductType.DRINGS).name("Fanta").description("0,5л").cost(50).img("https://pngimg.com/uploads/fanta/fanta_PNG10.png").build());
    }
